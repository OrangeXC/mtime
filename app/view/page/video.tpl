    ...
    <div class="content">
      <article class="message is-dark">
        ...
        <div class="message-body">
          由于三方的 api 不支持跨域视频访问，想观看视频请到
          <a href="http://movie.mtime.com/{{ movieId }}/trailer.html" target="_blank">
            http://movie.mtime.com/{{ movieId }}/trailer.html
          </a>
        </div>
      </article>
